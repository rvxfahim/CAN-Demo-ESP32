...
/* #define LECTURE_USE_BITS_SIGNAL */
...
/* #define LECTURE_USE_DIAG_MONITORS */


/* ------------------------------------------------------------------------- *
  When monitor using is enabled (LECTURE_USE_DIAG_MONITORS) and define below
